...
export default function Terms() {
  useSeo({
    ...
    description: 'شروط استخدام شات عسل تايم: الحقوق والالتزامات عند استخدام منصة الدردشة العراقية.',
    path: '/terms',
  })
  ...
  return (
    <section className="container-px max-w-3xl pb-14 pt-12 sm:pt-16">
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/[0.03] p-5 text-sm leading-relaxed text-slate-400">
        <p>
          باستخدامك لموقع «شات عسل تايم» فإنك تلتزم بالكامل بقوانين الدردشة («قوانين الدردشة») وبهذه
