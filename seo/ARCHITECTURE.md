...
- عدد صفحات HTML: 848 (منها 827 بالقالب المميّز premium).
...
الملف المرجعي: `seo/CONTENT_DATABASE.json` (827 صفحة) و`seo/CONTENT_INVENTORY.json`.

## 5) تخطيط الروابط (URLs)
- URL قصيرة، lowercase، بلا معرّفات، مع امتداد `.html` للجذر و`/` للأقسام.
- canonical ثابت على `https://www.chat-iraq.com`.
